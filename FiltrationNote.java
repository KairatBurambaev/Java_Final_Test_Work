...
public class FiltrationNote {
    ...
    public boolean notebookIsCorrect(Notebook notebook){
        ...
        for (Criterion criterion : criterionList){
            ...
            }else if (criterion.property.equals("Hard_disk")){
                valueNotebook = notebook.getHard_disk();
            }else if (criterion.property.equals("Sys")){
                valueNotebook = notebook.getSys();
    ...
    public FiltrationNote(Set<Notebook> notebooks) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public FiltrationNote(Set<Notebook> notebooks, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    ...
    public int getCriteria(){
        String text = "Введите цифру, критерия: ";
    ...
    public Map<String, String> descriptionsProperties(){
        ...
        map.put("name", "Название");
        map.put("RAM", "Оперативной памяти");
        map.put("Hard_disk", "Объём ЖД");
        map.put("Sys", "Операционная система");
        map.put("Color", "Цвет");
